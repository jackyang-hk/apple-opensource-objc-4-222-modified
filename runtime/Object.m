...
static id _internal_object_copyFromZone(Object *anObject, unsigned nBytes, void *z) 
{
	...
	obj = (*_zoneAlloc)((*(struct objc_class *)anObject).isa, nBytes, z);
...
static id _internal_object_dispose(Object *anObject) 
{
	...
	(*(struct objc_class *)anObject).isa = _objc_getFreedObjectClass ();
	free(anObject);
	return nil;
}
...
static id _internal_object_reallocFromZone(Object *anObject, unsigned nBytes, void *z) 
{
	...
	if ((*(struct objc_class *)anObject).isa == _objc_getFreedObjectClass ())
	...
	tmp = (*(struct objc_class *)anObject).isa; 
	(*(struct objc_class *)anObject).isa = _objc_getFreedObjectClass ();
	newObject = (Object*)malloc_zone_realloc(z, (void*)anObject, (size_t)nBytes);
	if (newObject) {
		(*(struct objc_class *)newObject).isa = tmp;
		return newObject;
	}
	else
            {
...
Ivar object_setInstanceVariable(id obj, const char *name, void *value)
{
	...
	if (obj && name) {
		...
		if ((ivar = class_getInstanceVariable((*(struct objc_class *)obj).isa, name))) {
